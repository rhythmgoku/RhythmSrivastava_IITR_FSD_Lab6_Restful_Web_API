package com.greatlearning.studentmanagement.configuration;
...
import com.greatlearning.studentmanagement.services.CustomUserDetailsServiceImpl;

@Configuration
@EnableWebSecurity
public class WebSecurityConfig {

	private static final String[] All_ALLOWED_PATHS = { "/", "/students", "/students/addnew", "/students/view/**", "/accessdenied" };

	private static final String[] ONLY_ADMIN_PATHS = { "/students/edit/**", "/students/delete/**" };
